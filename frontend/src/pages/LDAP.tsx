          ...
          <CardContent className="p-3 pl-8">
            <div className="flex flex-col items-start space-y-6">
              <div className="flex items-center">
                ...
                <Input type="text" className="w-60" placeholder="enter the domain or ip" />
              </div>
              <div className="flex items-center">
                <p className="  w-60">Base DN:</p>
                <Input type="text" className="w-60" placeholder="DC=example,DC=com" />
              </div>
              <div className="flex items-center">
              ...
              {bindMethod === "authenticating" && (
                <>
                  <div className="flex items-center">
                    ...
                    <Input type="text" className="w-60" placeholder="CN=ldap-reader,OU=ServiceAccounts,DC=example,DC=com" />
                  </div>
                  <div className="flex items-center">
              ...
              <div className="flex items-center">
                ...
                <Input type="text" className="w-60" placeholder="OU=Groups,DC=example,DC=com" />
              </div>
              <div className="flex items-center">
              ...
              <div className="flex items-center">
                ...
                <Input type="text" className="w-60" placeholder="AppUsers (optional)" />
              </div>
              <div className="flex items-center">
