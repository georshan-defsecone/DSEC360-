...
const HomeSettingSidebar = () => {
  return (
    <div className="flex-1 overflow-y-auto scrollbar-hide p-3 space-y-2">
      <button className="block w-full text-left px-4 py-2 rounded hover:bg-white font-medium">
        My Projects
      </button>
      <button className="block w-full text-left px-4 py-2 rounded hover:bg-white font-medium">
        All Projects
...
const Sidebar = ({ scanSettings, homeSettings, settings }: SidebarProps) => {
  return (
    <div className="h-screen flex flex-col w-65 p-6 justify-between">
      ...
      <div className="mt-4">
        <button className="flex items-center px-4 py-2 hover:bg-slate-100 rounded">
